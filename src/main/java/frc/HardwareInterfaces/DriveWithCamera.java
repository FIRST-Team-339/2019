...
// /**
// * Contains all game specific vision code, including code to drive to the
// switch
// * using vision
// *
...
// /**
// * Creates the drive with camera object. If a sensor listed is not used
// (except
...
// /**
// * Drives using the camera until it hits CAMERA_NO_LONGER_WORKS inches, where
// it
...
// * @return true if the robot has driven all the way to the front of the
// target,
...
// /**
// * drives to target with speed and compensation lower to allow for aligning
// from
// * close distances.
// *
// *
...
// /**
// * Code for 2019 camera to align to the rocket. returns Side that the camera
// see
// * vision targets on
// *
...
// // /**
// // * Code for 2019 camera to align to the rocket. returns Side that the
// camera
// // see
// // * vision targets on
// // *
...
// // /**
// // * Drives using the camera until it hits CAMERA_NO_LONGER_WORKS inches,
// where
// // it
// // * then drives using the ultrasonic, uses the janky relay fix
// // *
...
// // /**
// // * Gets the center x value of of the vision targets (average of the x
// values
// // of
// // * both visions targets)
// // *
...
// // // The minimum encoder distance we must drive before we enable the
// ultrasonic
...
// // // the distance from the wall (in inches) where we start stopping the
// robot
...
// // // private final double SWITCH_CAMERA_CENTER = 160;// Center of a 320x240
// // image
// // // // 160 originally
