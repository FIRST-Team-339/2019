...
public class VisionProcessor extends AutoGenVision {
    ...
    public VisionProcessor(String ip, CameraModel camera) {
        ...
        // stream.
        this.camera = CameraServer.getInstance().addAxisCamera("Vision Camera", ip);
     ...
     *
     */
    public VisionProcessor(String ip, CameraModel camera, DigitalOutput ringlightRelay) {
        // Adds the camera to the cscore CameraServer, in order to grab the
        // stream.
        this.camera = CameraServer.getInstance().addAxisCamera("Vision Camera", ip);
    ...
    public VisionProcessor(int usbPort, CameraModel camera) {
        // Adds the camera to the cscore CameraServer, in order to grab the
        // stream.
        this.camera = CameraServer.getInstance().startAutomaticCapture("Vision Camera", usbPort);
     ...
     */
    public VisionProcessor(int usbPort, CameraModel camera, DigitalOutput ringlightRelay) {
        // Adds the camera to the cscore CameraServer, in order to grab the
        // stream.
        this.camera = CameraServer.getInstance().startAutomaticCapture("Vision Camera", usbPort);
    ...
    public void processImage() {
        ...
        long errorCode = CameraServer.getInstance().getVideo("Vision Camera").grabFrame(image);
    ...
    public void saveImage(ImageType type) {
        ...
        // until we get one
        CameraServer.getInstance().getVideo("Vision Camera").grabFrame(tempImage);
